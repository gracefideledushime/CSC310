...
Correctness
Both versions produce identical MST costs (14 and 4226604), which confirms both implementations are correct. They just differ in efficiency.
...
V1: Quick Union without path compression
	...
	• This explains the 5.03 second runtime on 100k nodes
...
V2: Union-Find with path compression + union by rank
    ...
    • This explains the 0.11 second runtime on the same input